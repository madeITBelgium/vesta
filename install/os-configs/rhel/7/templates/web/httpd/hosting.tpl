<VirtualHost %ip%:%web_port%>
    ...
    <Directory %docroot%>
        ...
        php_admin_value open_basedir %docroot%:%home%/%user%/web/%domain%/public_html:%home%/%user%/tmp:/bin:/usr/bin:/usr/local/bin:/var/www/html:/tmp:/usr/share:/etc/phpMyAdmin:/etc/phpmyadmin:/var/lib/phpmyadmin:/etc/roundcubemail:/etc/roundcube:/var/lib/roundcube:/var/log/roundcubemail/
